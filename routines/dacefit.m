function  [dmodel, perf] = dacefit(X, Y, regr, corr, theta0, lob, upb, varargin)
    ...
    par = struct('corr',corr, 'regr',regr, 'X',X, 'Y',Y, 'F',feval(regr, X));
    ...
    dmodel = struct('regr',regr, 'corr',corr, 'theta',theta(:)', ...
          'beta',fit.beta, 'sigma2',fit.sigma2, 'X',X, 'Y',Y, 'Ft',fit.Ft, ...
