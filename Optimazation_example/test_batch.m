...
lb_GPBSS = [0.01*ones(1,p), 0];   ub_GPBSS = [20*ones(1,p), 1];   theta0_GPBSS = (lb_GPBSS + ub_GPBSS) / 2;
fitGP = @(X,Y,theta) fit_GPBSS(X, Y, @regpoly1, @corr_gauss, init_Bspline(4, [30 30]), lb_GPBSS, ub_GPBSS, theta);
